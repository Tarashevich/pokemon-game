...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Layout title='Cards' id={2} colorBg='linear-gradient(180deg, rgb(138, 203, 95), rgb(252, 155, 35))'>

          a.map(item => <PokemonCard name={this.name} img={this.img} id={this.id} type={this.type} values={a.values} />
